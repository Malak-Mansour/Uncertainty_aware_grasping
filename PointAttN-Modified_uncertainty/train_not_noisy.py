...
def train():
    ...
    # data_dir = './data_mix/data_occluded/coverage_0.3'
    data_dir = './data_mix/data_occluded/coverage_0.4'
    ...
    # data_dir = './data_mix/data_test_occluded/coverage_0.3'
    data_dir = './data_mix/data_test_occluded/coverage_0.4'
