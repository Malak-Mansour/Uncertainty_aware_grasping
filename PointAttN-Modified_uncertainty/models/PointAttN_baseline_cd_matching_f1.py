...
class PCT_refine(nn.Module):
    def __init__(self, channel=128, ratio=1):
        ...
        self.sa1 = cross_transformer(channel * 2, 512, dropout=0.0)
        self.sa2 = cross_transformer(512, 512, dropout=0.0)
        self.sa3 = cross_transformer(512, channel * ratio, dropout=0.0)
...
class PCT_encoder_PointAttN(nn.Module):
    def __init__(self, channel=64):
        ...
        self.sa1 = cross_transformer(channel, channel, dropout=0.0)
        self.sa1_1 = cross_transformer(channel * 2, channel * 2, dropout=0.0)
        self.sa2 = cross_transformer(channel * 2, channel * 2, dropout=0.0)
        self.sa2_1 = cross_transformer(channel * 4, channel * 4, dropout=0.0)
        self.sa3 = cross_transformer(channel * 4, channel * 4, dropout=0.0)
        self.sa3_1 = cross_transformer(channel * 8, channel * 8, dropout=0.0)

        self.relu = nn.GELU()

        self.sa0_d = cross_transformer(channel * 8, channel * 8, dropout=0.0)
        self.sa1_d = cross_transformer(channel * 8, channel * 8, dropout=0.0)
        self.sa2_d = cross_transformer(channel * 8, channel * 8, dropout=0.0)
